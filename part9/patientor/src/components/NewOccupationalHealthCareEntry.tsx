...
const NewOccupationalHealthcareEntry = ({
  ...
  const handleSubmit = async () => {
    try {
      const newEntry = {
        ...
        employerName: employerName.input.value,
      } as unknown as EntryWithoutId;
      if (startDate.input.value && endDate.input.value) {
  ...
  const display =
    show === "New Occupational Healthcare Entry"
      ? { ...mainStyle, display: "" }
  ...
  return (
    <div style={display}>
      <p>
        <strong>New Occupational Health Entry</strong>
      </p>
      <form onSubmit={handleSubmit}>
        ...
        <p>
          Employer <input {...employerName.input} />
        </p>
        <p>
          <strong>Sick Leave (Optional)</strong>
        </p>
        <ul>
          <li>
            Start Date <input {...startDate.input} />
          </li>
          <li>
            End Date <input {...endDate.input} />
          </li>
        </ul>
        Diagnosis Codes{" "}
        <Select
